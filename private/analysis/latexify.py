# following code copied from https://nipunbatra.github.io/2014/08/latexify/
# should be convenient function to make all my plots nicer.
...
def latexify(fig_width=None, fig_height=None, columns=1):
    ...
    params = {'backend': 'ps',
              ...
              'axes.labelsize': 3,  # fontsize for x and y labels (was 10)
              'axes.titlesize': 5,
